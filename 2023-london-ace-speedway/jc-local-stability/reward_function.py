    ...
    def reward_function(self, params):
       ...
       [-3.67571035e-01, -3.75680483e+00]]) 
        ...
        if is_offtrack:
            ...
            smooth_reward = 1
            is_speed_dropped = False
            is_steering_angle_changed = False
            ...
            if steps == 1:
                ...
                if last_idx >= 0:
                    ...
                    if prev_steering_angle == steering_angle and prev_speed == speed:
                        smooth_reward = 1.2
                    is_speed_dropped = prev_speed > speed
                    is_steering_angle_changed = prev_steering_angle == steering_angle
            ...
            # Given it is a straight line, when car has not dropped speed, then penalizes it
            speed_maintain_bonus = 1
            if (closest_waypoints[0] > 135 or closest_waypoints[1] < 10) and is_speed_dropped:
                speed_maintain_bonus = min( speed / prev_speed, 1 )
            ...
            print("heading rewards = " + format(heading_reward, ".3f") + " with bonus = " + format(steering_angle_maintain_bonus, "0.3f"))
